...
After the inventory, propose how to transform each important item into
the note system.
...
- merge into an existing concept note
- keep as supporting knowledge inside another concept note
- mention only in the source note
- preserve the source example or artifact
- simplify, generalize, replace, compress, or leave out source content
- represent as prose, bullets, table, diagram, flowchart, numbered
  chain, or another shape
